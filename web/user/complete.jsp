		...
		<div class='col-md-6 col-lg-5 mr-auto ml-auto'>
			<div class='card card-account'>
				<div class='card-body' style="text-align: center;">
					<span style="display:table-cell;vertical-align: middle;">아이디:${userDTO.userID}</span><br>
					<span style="display:table-cell;vertical-align: middle;">이름:${userDTO.userName}</span><br>
					<span style="display:table-cell;vertical-align: middle;">닉네임:${userDTO.userNickName}</span><br>
					<span style="display:table-cell;vertical-align: middle;">비밀번호${userDTO.userPwd}</span><br>
					<hr>
